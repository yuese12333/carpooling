-- Create core business tables for profile, vehicle, ride, trip, payment,
-- notification, help center, invite, safety and carbon modules.
...
CREATE TABLE `ride_orders` (
    ...
    `max_daily_orders_limit` INTEGER NULL,
